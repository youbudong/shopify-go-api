// package shopify provides methods for making requests to Shopify's admin API.
package shopify
...
type Client struct {
	...
	AbandonedCheckouts         AbandonedCheckoutsService
...
func NewClient(app App, shopName, token string, opts ...Option) *Client {
	...
	c.AbandonedCheckouts = &AbandonedCheckoutsServiceOp{client: c}
